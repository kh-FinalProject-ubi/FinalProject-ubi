...
public class IncheonFacilityServiceImpl implements IncheonFacilityService {
	...
	private static final Map<String, List<String>> apiUrlMap = Map.ofEntries(
			...
			entry("서구|노인맞춤돌봄",
					List.of("https://api.odcloud.kr/api/15090838/v1/uddi:1b22909e-39be-4569-8bbe-a2719688ea2a")),
			entry("서구|청소년복지",
					List.of("https://api.odcloud.kr/api/15090897/v1/uddi:49fd8133-54e7-43e7-8fe4-f30dab8f86ca")),
			entry("서구|행정복지",
					List.of("https://api.odcloud.kr/api/15102162/v1/uddi:3fed9081-8172-4cfd-8a7a-955bb8b41c0e")),
			entry("서구|노인보호",
					List.of("https://api.odcloud.kr/api/15136934/v1/uddi:710a0a5a-2824-409f-a5fe-83dc8a76050a")),
			entry("강화군|노인복지",
					List.of("https://api.odcloud.kr/api/15134073/v1/uddi:3e2a2b90-f731-4cd9-9f41-9afead42be33")),
			entry("강화군|노인의료복지",
					List.of("https://api.odcloud.kr/api/15143874/v1/uddi:f2c90b65-ea89-4124-9f26-d26482586b98")),
			entry("옹진군|노인복지",
					List.of("https://api.odcloud.kr/api/15134683/v1/uddi:97a568a5-cf1e-437b-b9fc-994ce5836e8a")),
			entry("옹진군|노인의료복지",
					List.of("https://api.odcloud.kr/api/15143875/v1/uddi:4894bf87-906f-4c5c-816f-8866e07957f2")),
			entry("중구|전체",
					List.of(
						"https://api.odcloud.kr/api/3079657/v1/uddi:ab663281-1316-45a5-8353-f285c0eb51ec",
						"https://api.odcloud.kr/api/15067056/v1/uddi:fe9221c6-ff29-4b1f-b31a-a3abd54cee9c",
						"https://api.odcloud.kr/api/3079646/v1/uddi:d2d90b19-c5bf-4a4c-981c-d651239861cf",
						"https://api.odcloud.kr/api/15072262/v1/uddi:80f4e422-58df-418e-a5e5-95c940ab49a7",
						"https://api.odcloud.kr/api/15066588/v1/uddi:7311017c-3cdb-42f8-9c09-8478ba1df6ff",
						"https://api.odcloud.kr/api/15038691/v1/uddi:589cf85a-41b7-41d9-a5a3-9ab937ea6ff5",
						"https://api.odcloud.kr/api/15133999/v1/uddi:62394c2f-3d8a-4b25-82b1-a9409644123a"
					)
				),

				entry("동구|전체",
					List.of(
						"https://api.odcloud.kr/api/15098031/v1/uddi:1bb2eaa8-a391-434e-93c4-8942ce80df9b",
						"https://api.odcloud.kr/api/15031810/v1/uddi:de86bbc2-01cc-4574-94ce-f763c99bc07e",
						"https://api.odcloud.kr/api/15098032/v1/uddi:93a70688-892f-45ec-8ccf-f30a8e5141f7"
					)
				),

				entry("미추홀구|전체",
					List.of(
						"https://api.odcloud.kr/api/15011882/v1/uddi:380f165a-9500-4c26-b792-b0b314ad72c2_201910101309",
						"https://api.odcloud.kr/api/15070559/v1/uddi:eae3eb26-6d5c-427a-9d96-acd687b9bee7",
						"https://api.odcloud.kr/api/15011892/v1/uddi:7624e013-b8e9-49af-8976-b2449672f51d",
						"https://api.odcloud.kr/api/15081949/v1/uddi:c5c91d21-1434-44c9-bc89-98cec45cddb2",
						"https://api.odcloud.kr/api/15126350/v1/uddi:eb9c2fe7-4fd6-4658-ab97-8129efa57d8d"
					)
				),

				entry("연수구|전체",
					List.of(
						"https://api.odcloud.kr/api/15133496/v1/uddi:d5495d77-f4b2-4912-893e-d9a340ad6709",
						"https://api.odcloud.kr/api/15085414/v1/uddi:32a02b56-c08b-4558-aafa-b0ea330224b6",
						"https://api.odcloud.kr/api/15064884/v1/uddi:1b660daa-c2e6-41e8-9f82-96df3956bb50",
						"https://api.odcloud.kr/api/15039268/v1/uddi:80df59c5-4b71-4491-a62a-b022a47ed25a"
					)
				),

				entry("남동구|전체",
					List.of(
						"https://api.odcloud.kr/api/3077722/v1/uddi:8100cb0c-e486-419e-96a2-c39a72eca629",
						"https://api.odcloud.kr/api/15067702/v1/uddi:b2c03e06-b507-40f6-9db8-c30e7e006410",
						"https://api.odcloud.kr/api/3043976/v1/uddi:c1c9ac92-b92e-405c-9f9f-c4b22521b134",
						"https://api.odcloud.kr/api/3077664/v1/uddi:7c8f6cbc-0efd-4f50-889f-f10090d5d76e",
						"https://api.odcloud.kr/api/3077601/v1/uddi:9f4884cd-932b-411d-b713-d129f5ced445",
						"https://api.odcloud.kr/api/15113039/v1/uddi:de76ae07-a685-4c8c-9009-e4577c57c9e4",
						"https://api.odcloud.kr/api/15104014/v1/uddi:9c01ddfd-0f7c-47e3-a49d-a0f5ba14a33d",
						"https://api.odcloud.kr/api/15113040/v1/uddi:73c8311a-bdf7-4163-aa4e-b6af04080b41",
						"https://api.odcloud.kr/api/15087604/v1/uddi:af03bf91-5c56-4b55-968a-dec99ef9c3fb",
						"https://api.odcloud.kr/api/15113041/v1/uddi:e83e393a-be36-441b-87cb-9e70f13653a1",
						"https://api.odcloud.kr/api/15119085/v1/uddi:b9ec4a6d-195e-4131-a280-f4380f19c3c7",
						"https://api.odcloud.kr/api/15113037/v1/uddi:5b0474ec-d73f-4214-b708-fb170d944445",
						"https://api.odcloud.kr/api/15133754/v1/uddi:66885f3f-772f-4662-a96b-f6192279d584"
					)
				),

				entry("부평구|전체",
					List.of(
						"https://api.odcloud.kr/api/3078614/v1/uddi:b1262eaf-14e9-4cb2-bc6d-b2a11ea4bf21",
						"https://api.odcloud.kr/api/3044744/v1/uddi:ac2affe2-0d1d-40df-a6c9-d869e5cb9492",
						"https://api.odcloud.kr/api/3078616/v1/uddi:868a6fe2-9816-4935-bbe9-e43679b51d12",
						"https://api.odcloud.kr/api/15104154/v1/uddi:721c6ac2-fe90-4993-824f-d45c5f26412e",
						"https://api.odcloud.kr/api/15104162/v1/uddi:466b0ac3-8ecd-467b-8ed2-febd15502f92"
					)
				),

				entry("계양구|전체",
					List.of(
						"https://api.odcloud.kr/api/15053541/v1/uddi:eea64658-3d29-4eca-aae2-b7ca76cc826d_201908231453",
						"https://api.odcloud.kr/api/15053540/v1/uddi:1ab7b464-dbda-48d6-962f-d64fee016053_201811051325",
						"https://api.odcloud.kr/api/15100621/v1/uddi:f0c8a0e6-bf32-4f3f-8b6a-c060e26e4d1c",
						"https://api.odcloud.kr/api/15100632/v1/uddi:712b0cab-eaaa-45d1-8a12-8277c256ec63",
						"https://api.odcloud.kr/api/15100624/v1/uddi:97e77691-42cf-4582-8b39-e235bf222ebd",
						"https://api.odcloud.kr/api/15100620/v1/uddi:5c5b5955-b4ff-4120-85ae-f0fe5ce7f1f4",
						"https://api.odcloud.kr/api/15100626/v1/uddi:d62e089e-b055-4b8f-9d22-eebd2b421db5",
						"https://api.odcloud.kr/api/15117135/v1/uddi:8531b4b1-bf14-4d00-8bc9-ea4352fc2f91"
					)
				),

				entry("서구|전체",
					List.of(
						"https://api.odcloud.kr/api/15055116/v1/uddi:1e36c8e4-2c74-4641-922c-909503b560e6",
						"https://api.odcloud.kr/api/3078097/v1/uddi:e27a0304-c896-48ef-9454-f6609d4f08cf",
						"https://api.odcloud.kr/api/15063137/v1/uddi:4415613e-f190-4387-b50c-ae22d7f94d6f",
						"https://api.odcloud.kr/api/15040126/v1/uddi:a5022b97-7d3e-45ce-9c58-b68109130315",
						"https://api.odcloud.kr/api/15090838/v1/uddi:1b22909e-39be-4569-8bbe-a2719688ea2a",
						"https://api.odcloud.kr/api/15090897/v1/uddi:49fd8133-54e7-43e7-8fe4-f30dab8f86ca",
						"https://api.odcloud.kr/api/15102162/v1/uddi:3fed9081-8172-4cfd-8a7a-955bb8b41c0e",
						"https://api.odcloud.kr/api/15136934/v1/uddi:710a0a5a-2824-409f-a5fe-83dc8a76050a"
					)
				),

				entry("강화군|전체",
					List.of(
						"https://api.odcloud.kr/api/15134073/v1/uddi:3e2a2b90-f731-4cd9-9f41-9afead42be33",
						"https://api.odcloud.kr/api/15143874/v1/uddi:f2c90b65-ea89-4124-9f26-d26482586b98"
					)
				),

				entry("옹진군|전체",
					List.of(
						"https://api.odcloud.kr/api/15134683/v1/uddi:97a568a5-cf1e-437b-b9fc-994ce5836e8a",
						"https://api.odcloud.kr/api/15143875/v1/uddi:4894bf87-906f-4c5c-816f-8866e07957f2"
					)
				)
	...
	private List<IncheonFacility> parseFacilityData(JsonNode root, String districtFilter, String url) {
		...
		for (JsonNode item : itemsNode) {
			...
			// 공통 기본 정보
			dto.setFacilityName(getFirst(item, "시설명", "기관명", "명칭", "경로당명", "지역아동센터명", "시설_단체명"));
			dto.setFacilityType(getFirst(item, "시설종류", "시설유형", "시설구분", "유형"));
			dto.setCategory(getFirst(item, "카테고리", "CATEGORY", "종류", "구분", "1차분류", "2차분류", "3차분류", "분류", "입소대상", "설립구분"));
			dto.setOperator(getFirst(item, "운영주체", "운영주체(법인명)", "법인", "법인명(재단명)", "법인(재단)명", "시설운영"));
			dto.setDirector(getFirst(item, "시설장"));
			dto.setNote(getFirst(item, "운영내용", "비고", "특이사항", "사업내용", "설립목적", "입소기간", "입소절차", "기타"));

			// 주소 및 지역
			dto.setAddress(getFirst(item, "도로명주소", "주소", "도로명 주소", "지번주소", "소재지", "주 소", "체육시설 소재지", "위치", "소 재 지"));
			dto.setDistrict(getFirst(item, "관할자치구", "행정동", "관할동", "동명", "동구분"));
			dto.setDistrict(districtFilter); // 마지막 override 지정 (필요 시 주석 처리 가능)

			// 연락처
			dto.setPhone(getFirst(item, "전화번호", "연락처"));
			dto.setFax(getFirst(item, "팩스", "팩스번호", "FAX번호"));
			...
			dto.setCurrentResidents(getFirst(item, "수용인원", "시설현원", "이용자수(현원)", "생활인수(명)", "입소인원"));
			dto.setCurrentUsers(getFirst(item, "계"));
			dto.setMaleCount(getFirst(item, "남"));
			dto.setFemaleCount(getFirst(item, "여"));

			// 설립일 / 지정일
			dto.setEstablishDate(getFirst(item, "설립일", "설립일자", "건축허가일", "지정일자", "설치연월", "설립연도", "인가일", "설치 승인일", "설치일자", "지정년도"));

			// 시설 규모 및 인력 정보
			dto.setScale(getFirst(item, "시설규모", "시설규모(제곱미터)", "건축물규모", "면적", "대지규모(제곱미터)", "건물규모(제곱미터)", "대지규모(미터제곱)", "건물규모(미터제곱)"));
			dto.setStaffCount(getFirst(item, "종사자수", "종사자", "종사자수(정원)", "종사자수(현원)", "직원현원"));
			...
			// 기타
			dto.setHomepage(getFirst(item, "홈페이지주소"));

			// 데이터 기준일
			dto.setDataDate(getFirst(item, "데이터기준일자", "데이터 기준일", "데이터기준일", "데이터 기준 일자"));
