...
public class Utility {
	...
	public static String generatePassword() {
		...
		// SecureRandom : 난수를 생성하기 위한 클래스,
		// 보안적으로 더 강력한 랜덤 값을 생성함.
		// 일반적인 Random 보다 예측 가능성이 낮아,
		// 민감한 데이터(암호 생성)와 같은 곳에 적합함.

		StringBuilder randomCode = new StringBuilder(CODE_LENGTH); // 가변성이 있는 메소드
		...
		for (int i = 0; i < CODE_LENGTH; i++) {
			...
			// CHARACTERS.charAt(index) 문자열의 index 위치에 있는 문자를 반환
